...
class CardViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        if let token = PersistentToken.getToken(){
            ...
            cardsApi.setCompletion { [weak self ](cards) in
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "CardCellView", for: indexPath) as? CardViewCell  else {
            fatalError("The dequeued cell is not an instance of CardViewCell.")
        }
               
        cell.setFromCard(card: cards[indexPath.row])
